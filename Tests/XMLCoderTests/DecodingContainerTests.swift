...
class DecodingContainerTests: XCTestCase {
    struct Foo: Codable {
        ...
        func encode(to encoder: Encoder) throws {
            ...
            var fooContainer = container.nestedContainer(keyedBy: FooCodingKeys.self, forKey: .foo)
        ...
        init(from decoder: Decoder) throws {
            ...
            let fooContainer = try container.nestedContainer(keyedBy: FooCodingKeys.self, forKey: .foo)
